...
The **Edocs** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter edocs test     # if vitest is configured
pnpm --filter edocs build    # production bundle (dist/)
```
