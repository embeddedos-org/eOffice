...
The **Edb** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter edb test     # if vitest is configured
pnpm --filter edb build    # production bundle (dist/)
```
