...
The **Edrive** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter edrive test     # if vitest is configured
pnpm --filter edrive build    # production bundle (dist/)
```
