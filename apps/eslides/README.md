...
The **Eslides** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter eslides test     # if vitest is configured
pnpm --filter eslides build    # production bundle (dist/)
```
