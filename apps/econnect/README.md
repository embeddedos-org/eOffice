...
The **Econnect** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter econnect test     # if vitest is configured
pnpm --filter econnect build    # production bundle (dist/)
```
