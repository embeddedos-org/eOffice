...
The **Eforms** app is part of the **eOffice Suite** — an open-source AI-powered office productivity stack with built-in eBot LLM integration.
...
```bash
pnpm --filter eforms test     # if vitest is configured
pnpm --filter eforms build    # production bundle (dist/)
```
